...
//These are the tests for part 4 comment out for part 3
    ...
    //These are the tests for part 3 comment out for part 3
/*
    @Test
    public void getMessage() {
        assertNotNull(fixture);
    ...
    public void getTest3() {
        assertNotNull(fixture);
        String[] storageCheck = {"The integer entered must be greater than or equal to 1"};
        assertArrayEquals(storageCheck, fixture.fizzBuzz(0));
    }
    ...
    public void getTest5() {
        assertNotNull(fixture);
        String[] storageCheck = {"The integer entered must be greater than or equal to 1"};
        assertArrayEquals(storageCheck, fixture.fizzBuzz(-10));
    }*/
